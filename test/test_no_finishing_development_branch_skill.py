"""Regression checks for the retired finishing-a-development-branch Skill."""
...
RETIRED_DIR = REPO_ROOT / "skills" / "finishing-a-development-branch"
...
class NoFinishingDevelopmentBranchSkillTests(unittest.TestCase):
